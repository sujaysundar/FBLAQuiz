...
logging.basicConfig(filename = '../logs/FBLAQuiz.log', filemode = 'a', format = '%(asctime)s - %(message)s', level=logging.INFO)
...
def insertStudent(student_id,name,grade):
	...
	#Logging entry in the log file
	logging.info(student_id+" student record is being added")
	...
	try:
		...
		if(student_id==""F or name=="" or grade==""):
			...
			#Logging entry in the log file
			logging.info(student_id+" student record is successfully added")
		...
		print(e)
		#Log the error
		logging.error("Exception occurred for '"+student_id+"' while adding student record" +e, exc_info = True)
	finally:
...
def deleteStudent(student_id,student_name):
	...
	#Logging entry in the log file
	logging.info(student_id+" student record is being deleted")
	...
	try:
		...
		if(student_id==""):
			...
			#Logging entry in the log file
			logging.info(student_id+" student record is successfully deleted")
		...
		print(e)
		#Log the error
		logging.error("Exception occurred for '"+student_id+"' while deleting student record" +e, exc_info = True)
	finally:
		#Free up resources like open DB connections, etc.
		con.close();
...
def updateStudent(student_id,name,grade):
	...
	#Logging entry in the log file
	logging.info(student_id+" student record is being updated")
	...
	try:
		...
		if(student_id==""):
			...
			#Logging entry in the log file
			logging.info(student_id+" student record is successfully updated")
		...
		print(e)
		#Log the error
		logging.error("Exception occurred for '"+student_id+"' while updating student record" +e, exc_info = True)
	finally:
		#Free up resources like open DB connections, etc.
		con.close();
...
def checkStudentAnswers(student_id,question1,answer1,question2,answer2,question3,answer3,question4,answer4,question5,answer5):
	...
	logging.info("In checkStudentAnswers function while "+student_id+" is attempting the quiz")
	...
	try:
		...
		print(e)
		#Log the error
		logging.error("Exception occurred for '"+student_id+"' while checking quiz answers" +e, exc_info = True)
	finally:
		#Free up resources like open DB connections, etc.
		con.close();
...
def insertStudentScore(student_id,score):
	...
	logging.info("In insertStudentScore function while "+student_id+" is attempting the quiz")
	...
	try:
		...
		#Create entry in the log file
		logging.info(student_id+" has successfully completed the quiz")
		
	except Exception as e:
		#print any exceptions encountered in executing above block of code
		print(e)
		#Log the error
		logging.error("Exception occurred for '"+student_id+"' while completing the quiz" +e, exc_info = True)
	finally:
		#Free up resources like open DB connections, etc.
		con.close();
